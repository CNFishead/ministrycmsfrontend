...
import { useUpdateBillingData } from '@/state/billing/billing';
...
const EditPaymentInfoModal = (props: Props) => {
  ...
  const [currentView, setCurrentView] = useState<'current' | 'cc' | 'ach'>(
    'current'
  );
